...
<head>
    ...
    <script src="../../JS/npm.js" rel=“text/javascript">
<script>
    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li class=“active”><a href=“../../ETC.html”>ETC</a></li>
            </ul>
        </div><!--/.nav-collapse -->
    </div>
</nav>
...
for sentence in md_file:
        tmp = re.sub(r"""(#{6}) ([\w!@#$%^&*()_\-{}[\]:";'<>?,./|\\=+]*) ([\w!@#$%^&*( )_\-{}[\]:";'<>?,./|\\=+]*)""", r'<h6>\2<small>\3</small></h6>', sentence)
        tmp = re.sub(r"""(#{5}) ([\w!@#$%^&*()_\-{}[\]:";'<>?,./|\\=+]*) ([\w!@#$%^&*( )_\-{}[\]:";'<>?,./|\\=+]*)""", r'<h5>\2<small>\3</small></h5>', tmp)
        tmp = re.sub(r"""(#{4}) ([\w!@#$%^&*()_\-{}[\]:";'<>?,./|\\=+]*) ([\w!@#$%^&*( )_\-{}[\]:";'<>?,./|\\=+]*)""", r'<h4>\2<small>\3</small></h4>', tmp)
        tmp = re.sub(r"""(#{3}) ([\w!@#$%^&*()_\-{}[\]:";'<>?,./|\\=+]*) ([\w!@#$%^&*( )_\-{}[\]:";'<>?,./|\\=+]*)""", r'<h3>\2<small>\3</small></h3>', tmp)
        tmp = re.sub(r"""(#{2}) ([\w!@#$%^&*()_\-{}[\]:";'<>?,./|\\=+]*) ([\w!@#$%^&*( )_\-{}[\]:";'<>?,./|\\=+]*)""", r'<h2>\2<small>\3</small></h2>', tmp)
        tmp = re.sub(r"""(#{1}) ([\w!@#$%^&*()_\-{}[\]:";'<>?,./|\\=+]*) ([\w!@#$%^&*( )_\-{}[\]:";'<>?,./|\\=+]*)""", r'<h1>\2<small>\3</small></h1>', tmp)
